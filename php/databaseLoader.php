			...
			<tr>
				...
				<td class="code"><div class="container">
						...
						<div class="line number2 index1 alt1">
							...
							<code class="js comments">// Setup - add a text input to each
								footer cell</code>
						</div>
						<div class="line number3 index2 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">$(</code>
							<code class="js string">'#example thead tr'</code>
							<code class="js plain">).clone(</code>
							<code class="js keyword">true</code>
							<code class="js plain">).appendTo( </code>
							<code class="js string">'#example thead'</code>
							<code class="js plain">);</code>
						</div>
						<div class="line number4 index3 alt1">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">$(</code>
							<code class="js string">'#example thead tr:eq(1) th'</code>
							<code class="js plain">).each( </code>
							<code class="js keyword">function</code>
							<code class="js plain">(i) {</code>
						</div>
						<div class="line number5 index4 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js keyword">var</code>
							<code class="js plain">title = $(</code>
						...
						<div class="line number6 index5 alt1">
							...
							<code class="js string">'&lt;input type="text"
						...
						<div class="line number8 index7 alt1">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">$( </code>
							<code class="js string">'input'</code>
							<code class="js plain">, </code>
							<code class="js keyword">this</code>
							<code class="js plain">).on( </code>
							<code class="js string">'keyup change'</code>
							<code class="js plain">, </code>
							<code class="js keyword">function</code>
							<code class="js plain">() {</code>
						</div>
						<div class="line number9 index8 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js keyword">if</code>
							<code class="js plain">( table.column(i).search() !== </code>
							<code class="js keyword">this</code>
						...
						<div class="line number11 index10 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">.column(i)</code>
						</div>
						<div class="line number12 index11 alt1">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">.search( </code>
							<code class="js keyword">this</code>
							<code class="js plain">.value )</code>
						</div>
						<div class="line number13 index12 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">.draw();</code>
						</div>
						...
						<div class="line number19 index18 alt2">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">orderCellsTop: </code>
							<code class="js keyword">true</code>
							<code class="js plain">,</code>
						</div>
						<div class="line number20 index19 alt1">
							<code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="js plain">fixedHeader: </code>
							<code class="js keyword">true</code>
						</div>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				...
				<td class="code"><div class="container">
						<div class="line number1 index0 alt2">
							<code class="css plain">thead input {</code>
						</div>
						<div class="line number2 index1 alt1">
							<code class="css spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code>
							<code class="css keyword">width</code>
							<code class="css plain">: </code>
							<code class="css value">100%</code>
							<code class="css plain">;</code>
						</div>
						<div class="line number3 index2 alt2">
							<code class="css spaces">&nbsp;&nbsp;&nbsp;&nbsp;</code>
