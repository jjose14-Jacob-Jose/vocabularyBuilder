...
(function(c) {
    ...
    c.extend(m.prototype, {
        ...
        _clone: function(a, b) {
            ...
            !b && d.floating ? d.floating.removeClass("fixedHeader-floating fixedHeader-locked") : (d.floating && (d.placeholder.remove(),
            this._unsize(a),
        ...
        _horizontal: function(a, b) {
            var c = this.dom[a]
              , d = this.s.position
              , k = this.s.scrollLeft;
            c.floating && k[a] !== b && (c.floating.css("left", d.left - b),
            k[a] = b)
        },
        _modeChange: function(a, b, e) {
            ...
            h && h.blur();
            "in-place" === a ? (d.placeholder && (d.placeholder.remove(),
            d.placeholder = null),
            this._unsize(b),
            "header" === b ? d.host.prepend(f) : d.host.append(f),
            d.floating && (d.floating.remove(),
            d.floating = null)) : "in" === a ? (this._clone(b, e),
            d.floating.addClass("fixedHeader-floating").css("header" === b ? "top" : "bottom", this.c[b + "Offset"]).css("left", k.left + "px").css("width", k.width + "px"),
            "footer" === b && d.floating.css("top", "")) : "below" === a ? (this._clone(b, e),
            d.floating.addClass("fixedHeader-locked").css("top", k.tfootTop - k.theadHeight).css("left", k.left + "px").css("width", k.width + "px")) : "above" === a && (this._clone(b, e),
            d.floating.addClass("fixedHeader-locked").css("top", k.tbodyTop).css("left", k.left + "px").css("width", k.width + "px"));
        ...
        _positions: function() {
            ...
            k.length ? (b.tfootTop = k.offset().top,
...
//    ORIGINAL LINES
    ...
    c(g).on("init.dt.dtfh", function(a, b, e) {
        ...
        !a && !e || b._fixedHeader || (e = c.extend({}, e, a),
        !1 !== a && new m(b,e)))
    });
